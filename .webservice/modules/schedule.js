   ...
   constructor() {
      ...
      this.start = function(options) {
         ...
         const set_options = {
            ...
            type: options && options.type ? options.type : 'recursive',
            timeInterval: options && options.timeInterval ? options.timeInterval : 0,
            recursive: options && options.recursive ? options.recursive : true
         };

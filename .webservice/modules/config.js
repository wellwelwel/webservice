...
if (!config?.dev || !config?.dev?.ftp || typeof config?.dev?.ftp?.root !== 'string' || typeof config?.dev?.ftp?.host  !== 'string'|| typeof config?.dev?.ftp?.user  !== 'string'|| typeof config?.dev?.ftp?.pass  !== 'string'|| typeof config?.dev?.ftp?.secure !== 'string') {
